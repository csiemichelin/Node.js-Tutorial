...
// //讀取文件內容
// let data = fs.readFileSync('./資料/彩虹貓-rainbow.gif');
// //寫入文件
// fs.writeFileSync('./資料/彩虹貓-rainbow-2.gif', data);
...
// 創建流式對象
const rs = fs.createReadStream("./資料/彩虹貓-rainbow.gif");
//創建寫入對象
const ws = fs.createWriteStream("./資料/彩虹貓-rainbow-3.gif");
